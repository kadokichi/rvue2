class RegulationsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to regulations_path, status: :see_other, notice: "Regulation was successfully destroyed." }
  ...
  private
    ...
    def regulation_params
      params.require(:regulation).permit(:begin_time, :close_time, :interval_s, :interval_e, :unit_minute, :versions)
    end
end
