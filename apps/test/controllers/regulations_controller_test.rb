...
class RegulationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create regulation" do
    assert_difference("Regulation.count") do
      post regulations_url, params: { regulation: { begin_time: @regulation.begin_time, close_time: @regulation.close_time, interval_e: @regulation.interval_e, interval_s: @regulation.interval_s, unit_minute: @regulation.unit_minute, versions: @regulation.versions } }
    end
  ...
  test "should update regulation" do
    patch regulation_url(@regulation), params: { regulation: { begin_time: @regulation.begin_time, close_time: @regulation.close_time, interval_e: @regulation.interval_e, interval_s: @regulation.interval_s, unit_minute: @regulation.unit_minute, versions: @regulation.versions } }
